...
public class AirportApp3 {
    ...
    public static void main(String[] args)  {
     ...
     //   String inputFile = "";
        ...
        JavaPairRDD<Tuple2<String,String>, Times> fDelay = fAIRPORT_TIMES.map( s -> s.split(",")).mapToPair(strings -> new Tuple2<>(new Tuple2<>(strings[], strings[]), new Times(strings[],strings[])))
